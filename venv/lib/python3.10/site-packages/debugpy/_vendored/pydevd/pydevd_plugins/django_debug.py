...
def add_line_breakpoint(plugin, pydb, type, canonical_normalized_filename, breakpoint_id, line, condition, expression,
    ...
    if type == 'django-line':
        django_line_breakpoint = DjangoLineBreakpoint(canonical_normalized_filename, breakpoint_id, line, condition,
    ...
    if event == 'call' and info.pydev_state != STATE_SUSPEND and py_db.django_breakpoints and _is_django_render_call(
        ...
        if django_breakpoints_for_file:
            ...
            if IS_DJANGO19_OR_HIGHER:
                ...
                django_validation_info.verify_breakpoints(py_db, canonical_normalized_filename,
            ...
            if exception.__name__ == 'TemplateSyntaxError':
                ...
                if lineno is not None:
                    ...
                    if original_filename is None:
                        ...
                        # load_template.
                        original_filename = _get_original_filename_from_origin_in_parent_frame_locals(frame,
                                                                                                      'load_template')
