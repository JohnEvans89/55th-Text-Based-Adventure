...
from _pydevd_bundle.pydevd_comm_constants import (
    ...
    CMD_LOAD_SOURCE, CMD_SET_NEXT_STATEMENT, CMD_GET_FILE_CONTENTS,
...
from _pydevd_bundle.pydevd_constants import (DebugInfoHolder,
                                             get_thread_id)  # Keep for backward compatibility @UnusedImport
...
class NetCommandFactory(object):
    ...
    def make_custom_frame_created_message(self, frame_id, frame_description):
        ...
        return NetCommand(CMD_THREAD_CREATE, 0,
    ...
    def _iter_visible_frames_info(self, py_db, frames_list, flatten_chained=False):
        ...
        while True:
            for frame in frames_list:
                ...
                filename_in_utf8, lineno, changed = py_db.source_mapping.map_to_client(abs_path_real_path_and_base[0],
                                                                                       lineno)
                ...
                yield frame_id, frame, method_name, abs_path_real_path_and_base[
                    0], new_filename_in_utf8, lineno, applied_mapping, show_as_current_frame, line_col_info
    ...
    def make_send_curr_exception_trace_message(self, py_db, seq, thread_id, curr_frame_id, exc_type, exc_desc,
                                               trace_obj):
        try:
