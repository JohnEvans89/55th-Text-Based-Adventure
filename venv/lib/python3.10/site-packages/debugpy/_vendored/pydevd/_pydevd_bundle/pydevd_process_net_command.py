...
class _PyDevCommandProcessor(object):
    ...
    def cmd_smart_step_into(self, py_db, cmd_id, seq, text):
        ...
        if line_or_bytecode_offset.startswith('offset='):
            ...
            return self.api.request_smart_step_into_by_func_name(py_db, seq, thread_id, line_or_bytecode_offset,
                                                                 func_name)
    ...
    def cmd_remove_break(self, py_db, cmd_id, seq, text):
        ...
        try:
            ...
            pydev_log.critical('Error removing breakpoint. Expected breakpoint_id to be an int. Found: %s',
                               breakpoint_id)
    ...
    def cmd_set_py_exception_json(self, py_db, cmd_id, seq, text):
        ...
        try:
            ...
            py_db.skip_on_exceptions_thrown_in_same_context = as_json.get('skip_on_exceptions_thrown_in_same_context',
                                                                          False)
    ...
    def cmd_get_smart_step_into_variants(self, py_db, cmd_id, seq, text):
        ...
        py_db.post_method_as_internal_command(
            thread_id, internal_get_smart_step_into_variants, seq, thread_id, frame_id, start_line, end_line,
